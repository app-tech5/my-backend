/**
 * Seed des notifications backend pour le compte driver démo.
 * Liées à de vraies commandes du driver quand disponibles.
 *
 * up   → insère des notifications (skip si déjà seedées)

/**
 * Seeds coherent demo notifications for all customer users.
 * Each customer gets a realistic set of notifications linked to their
 * actual orders (when available) and the platform restaurants.
 *

/**
 * Replace noisy faker subscriptions with clear monetization plans,
 * and fill sponsored listings so Admin screens are not sparse.
 */
module.exports = {
  async up(db) {
    const now = new Date();
    ...
    // Hide faker noise from list screens
